...
\subject{What is ConTeXt?}

\CONTEXT~is a typesetting system developed in 1992 by Hans Hagen from
PRAGMA-ADEin Hasselt, The Netherlands. Is an advanced macro package for
creating professional quality documents in pdf, html and xml
formats. The traditional word processors such as Writer, Abword, or MS
word may be limited with large and complex documents. This means that
we need to type many text, mathematical and chemical formulas,
inserting figures and create tables. \CONTEXT~ is a professional
typesetting software with many commands that will help you make your
papers look like a high quality scientific journal. This will increase
your motivation and creativity in the writing process.

\subject{How \CONTEXT~works?}

Think \CONTEXT~as an programming language, this means that you need to
...
to be saved. To avoid potential errors the name of the file must not
...
Before install \CONTEXT~and TexWorks and use in you own machine,
you can follow this guide in the online version in a web browser. Copy
the following link and paste in your web browser,
...
\placefigure[]
   ...
   \startframedtext[width=\textwidth]
     The examples presented in this chapter (The Basics) can be copied
...
Now we can write a paragraph. In the source file the we do not care
about formatting the paragraph, the optimal length of the lines in the
...
\page
 ...
 In between we use the command \type{\item} following the text of the list, every
 ...
 tell to \CONTEXT~to put numbers instead of bullets in the list, in
...
If there are to many elements to list, we can divide into columns as follow.
 ...
 \type{a, A, r, R, 1, 2, 3}. Try and see the result.


 \subject{Sub/superscript}

 The command \type{\low{}} and \type{\high{}} are use text as sub or
...
Resolve the following equation $y = a + b - c$
